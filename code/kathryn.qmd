...
```{r}
# excess mortality per 100k per week per state
dat_waves |> filter(!is.na(wave)) |>
...
# Wave 1
wave_1_em |> arrange(desc(em_rate_per_100k))
wave_1_em |> arrange(em_rate_per_100k)

# Wave 2
wave_2_em |> arrange(desc(em_rate_per_100k))
wave_2_em |> arrange(em_rate_per_100k)

# Wave 3
wave_3_em |> arrange(desc(em_rate_per_100k))
wave_3_em |> arrange(em_rate_per_100k)

# Wave 4
wave_4_em |> arrange(desc(em_rate_per_100k))
wave_4_em |> arrange(em_rate_per_100k)

# Wave 5
wave_5_em |> arrange(desc(em_rate_per_100k))
wave_5_em |> arrange(em_rate_per_100k)
```

``` {r}
# does covid explain it?
dat_waves |> filter(!is.na(wave)) |>
